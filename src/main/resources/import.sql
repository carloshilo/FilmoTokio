...
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (41, false, 'Guardianes de la Galaxia Especial felices fiestas.jpg', 'Con la intención de que Peter tenga una Navidad inolvidable, Mantis y Drax viajan a la Tierra para conseguir el regalo perfecto.', 'Guardianes de la Galaxia: Especial felices fiestas', 2022, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (134, false, 'Animales fantásticos Los crímenes de Grindelwald.jpeg', 'Cumpliendo con su amenaza, el mago Gellert Grindelwald escapa de su custodia y empieza a reunir seguidores con el objetivo de alzar a los magos purasangre para reinar sobre todas las criaturas mágicas.', 'Animales fantásticos: Los crímenes de Grindelwald', 2018, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (108, false, 'La_llamada.jpg', 'María y Susana, dos adolescentes rebeldes, pasan el verano en un campamento católico. Con la música como denominador común, la rebelión de los adolescentes y el orden eclesiástico chocarán, creando un himno a la libertad y al primer amor.', 'La llamada', 2017, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (94, false, 'La familia Addams_ La tradición continúa (1993).jpg', 'La Familia Addams intenta rescatar a su amado tío Fétido de su nuevo amor, una viuda negra llamada Debbie.', 'La familia Addams: La tradición continúa', 1993, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (115, false, 'Smile.png', 'Después de presenciar un incidente extraño que involucra a un paciente, la Dra. Rose Cotter comienza a experimentar sucesos aterradores. Rose debe enfrentarse a su inquietante pasado para poder sobrevivir y escapar de su nueva realidad.', 'Smile', 2022, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (117, false, 'Pinocchio_(2022_animated_film).jpg', 'Una versión más oscura del clásico cuento infantil de una marioneta de madera que se transforma en un niño vivo de verdad.', 'Pinocho de Guillermo del Toro', 2022, 1, 0);
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (102, false, 'Encanto.jpeg', 'En Colombia, una joven lidia con la frustración de ser la única miembro de la familia que no tiene poderes mágicos.', 'Encanto', 2021, 1, 0);
