...
insert into films (duration, migrate, poster, synopsis, title, year, user_id, avg_score) values (134, false, 'Animales fantásticos Los crímenes de Grindelwald.jpg', 'Cumpliendo con su amenaza, el mago Gellert Grindelwald escapa de su custodia y empieza a reunir seguidores con el objetivo de alzar a los magos purasangre para reinar sobre todas las criaturas mágicas.', 'Animales fantásticos: Los crímenes de Grindelwald', 2018, 1, 0);
